class Util {
    ...
    static getShader(shaderSource, shaderType) {
    ...
    static getProgram(vsSource, fsSource) {
        const vs = this.getShader(vsSource, gl.VERTEX_SHADER) ;
        const fs = this.getShader(fsSource, gl.FRAGMENT_SHADER) ;
    ...
    static createBuffer( coords, type = gl.ARRAY_BUFFER) {
